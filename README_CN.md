...
[Muon 优化器](https://github.com/KellerJordan/Muon) 的即插即用加速方案。通过自定义 CuTe SYRK 内核利用**矩阵对称性**加速 Newton-Schulz 正交化。每步 NS 迭代速度提升 **最高 1.4 倍**，训练效果**完全一致**。
...
> FusedMuon 和 VanillaMuon 的训练曲线**完全重合**（loss 和 accuracy 一致），确认数值等价性。每步 NS 迭代在大矩阵上加速 **1.3–1.4 倍**。
